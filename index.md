...
- Trained and compressed deep learning models with PyTorch, resulting in ~40% model size reduction and ~30% inference speedup to meet SoC constraints
- Constructed and curated 100K+ image datasets and implemented automated labeling tools, accelerating annotation efficiency by ~30%
...
- Published 2 peer-reviewed journal papers and 4 conference papers on image processing and deep learning applications
- Designed a deep tripartite network for license plate glare removal, attaining PSNR 41.16 dB and SSIM 0.9908, surpassing prior methods and demonstrating applicability to real-world vision systems
...
- Established large-scale databases for [smoke](https://bigmms.github.io/cheng_gcce19_smoke100k/) (100K samples) and [solar glare](https://bigmms.github.io/chen_tits21_dataset/) (87.5K samples) datasets, enabling AI-based image restoration and machine learning research
